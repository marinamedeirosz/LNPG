newtype Empregado = Empregado (String Int String Double Departamento)
...
transferirEmpregado (Empregado (nome id cargo salario departamento)) novoDepartamento = Empregado (nome id cargo salaario novoDepartamento)


newtype Departamento = Departamento (String Int String [Empregado])
...
addEmpregado (Empregado (nome id cargo salario departamento)) (Departamento (nome id localizacao empregados)) = Departamento (nome id localizacao (empregado : empregados))
